...
class resume_controller extends user{
	function index_action(){
		...
		$rows=$this->obj->DB_select_all("resume_expect","`uid`='".$this->uid."' order by defaults desc,lastupdate desc","id,name,lastupdate,doc,tmpid,integrity,hits,height_status,statusbody,`topdate`,`top`,`r_status`,`status`");
	...
	function del_action(){
		...
		$del_array=array("resume_cert","resume_edu","resume_other","resume_project","resume_skill","resume_training","resume_work","resume_doc","user_resume","resume_show","down_resume","userid_job","user_entrust_record");
