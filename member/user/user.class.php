...
class user extends common{
	...
	function public_action(){
		...
		if($_GET['c']==''){
			...
			$this->yunset("left",3);
		}elseif($_GET['c']=='paylist'||$_GET['c']=='paylog'|| $_GET['c']=='integral' || $_GET['c']=='integral_reduce' || $_GET['c']=='reward_list' || $_GET['c']=='pay' || $_GET['c']=='payment'||$_GET['m']=='invitereg' || $_GET['act']=='loglist' || $_GET['act']=='change'|| $_GET['act']=='changelist' ){
