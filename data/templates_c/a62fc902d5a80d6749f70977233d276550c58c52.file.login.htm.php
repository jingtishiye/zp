<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-06-17 17:33:00
         compiled from "/www/wwwroot/zp.canyinyunfu.com/app/template/default/ajax/login.htm" */ ?>
<?php /*%%SmartyHeaderCode:5102649315ee9e34c392122-62461758%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a62fc902d5a80d6749f70977233d276550c58c52' => 
    array (
      0 => '/www/wwwroot/zp.canyinyunfu.com/app/template/default/ajax/login.htm',
      1 => 1550634620,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5102649315ee9e34c392122-62461758',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9e34c3d96f5_37652328',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9e34c3d96f5_37652328')) {function content_5ee9e34c3d96f5_37652328($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/wwwroot/zp.canyinyunfu.com/app/include/libs/plugins/function.url.php';
...
/member/index.php?c=job&w=1"><span class="login_after_zt_list_n"><?php echo $_smarty_tpl->tpl_vars['company']->value['job'];?>
  ...
  <div class="login_after_zt_list login_after_zt_list_end"><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/member/index.php?c=talent_pool"><span class="login_after_zt_list_n"><?php echo $_smarty_tpl->tpl_vars['company']->value['status2'];?>
</span>收藏简历</a>
  </div>
...
/member/index.php?c=job&s=1"><span class="login_after_zt_list_n"><?php echo $_smarty_tpl->tpl_vars['lt']->value['lt_job'];?>
  ...
  <div class="login_after_zt_list login_after_zt_list_end"><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/member/index.php?c=down_resume"><span class="login_after_zt_list_n"><?php echo $_smarty_tpl->tpl_vars['lt']->value['lt_status2'];?>
</span>下载简历</a></div>
</div>
<div class="login_after_bthbox"> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
...
<div class="login_after_welcome">欢迎登录</div>
<div class="login_after_user_box">
  <div class="login_after_user_photo"> <img width="60" height="60" src="<?php echo $_smarty_tpl->tpl_vars['member']->value['logo'];?>
" onerror="showImgDelay(this,'<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_member_icon'];?>
',2);"></div>
  <div class="login_after_user_name">
...
>
	  ...
	  <style>.index_verification .geetest_holder.geetest_wind{min-width:247px;}</style>
		...
		<div class=" hp_login_yzbox">
			...
			<input type="text" id="txt_CheckCode" name="authcode" value="验证码" class="yun_Indexlogin_yzm" maxlength="6">
