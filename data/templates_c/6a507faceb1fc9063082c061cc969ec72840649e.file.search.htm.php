<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-06-17 19:17:29
         compiled from "/www/wwwroot/zp.canyinyunfu.com/app/template/default/resume/search.htm" */ ?>
<?php /*%%SmartyHeaderCode:20844960855ee9fbc9dbcf17-89638807%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a507faceb1fc9063082c061cc969ec72840649e' => 
    array (
      0 => '/www/wwwroot/zp.canyinyunfu.com/app/template/default/resume/search.htm',
      1 => 1551748492,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20844960855ee9fbc9dbcf17-89638807',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9fbc9f39920_91924622',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9fbc9f39920_91924622')) {function content_5ee9fbc9f39920_91924622($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/wwwroot/zp.canyinyunfu.com/app/include/libs/plugins/function.url.php';
...
// 				$user3[$k]['job_city_three']=$city_name[$v['three_cityid']];
			...
			foreach($user3 as $k=>$v){
               if($paramer['keyword']){
					...
					$user3[$k]['name_n']=str_replace($paramer['keyword'],"<font color=#FF6600 >".$paramer['keyword']."</font>",$user3[$k]['name']);
...
// 				$user2[$k]['job_city_three']=$city_name[$v['three_cityid']];
			...
			foreach($user2 as $k=>$v){
               if($paramer['keyword']){
					...
					$user2[$k]['name_n']=str_replace($paramer['keyword'],"<font color=#FF6600 >".$paramer['keyword']."</font>",$user2[$k]['name']);
...
// 				$user[$k]['job_city_three']=$city_name[$v['three_cityid']];
			...
			foreach($user as $k=>$v){
               if($paramer['keyword']){
					...
					$user[$k]['name_n']=str_replace($paramer['keyword'],"<font color=#FF6600 >".$paramer['keyword']."</font>",$user[$k]['name']);
...
// 				$userrec[$k]['job_city_three']=$city_name[$v['three_cityid']];
			...
			foreach($userrec as $k=>$v){
               if($paramer['keyword']){
					...
					$userrec[$k]['name_n']=str_replace($paramer['keyword'],"<font color=#FF6600 >".$paramer['keyword']."</font>",$userrec[$k]['name']);
